(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vueBimonthlyCalendar"] = factory();
	else
		root["vueBimonthlyCalendar"] = factory();
})(this, function() {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    dayList: function dayList() {
      var firstDay = new Date(this.calendar.params.curYear, this.calendar.params.curMonth, 0);
    ...
    lastDayList: function lastDayList() {
      var firstDay = new Date(this.calendar.params.lastYear, this.calendar.params.lastMonth, 0);
      var startDate = new Date(firstDay);
      startDate.setDate(firstDay.getDate() - firstDay.getDay() + this.calendar.options.weekStartOn);
    ...
    startDay: function startDay() {
      var dateObj = new Date(this.events[0].date);
    ...
    lastYearMonth: function lastYearMonth() {
      var tempDate = Date.parse(new Date(this.calendar.params.lastYear + '/' + (this.calendar.params.lastMonth + 1) + '/01'));
      return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__tools_js__["b" /* dateTimeFormatter */])(tempDate, this.i18n[this.calendar.options.locale].format);
    },
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__vue_bimonthly_calendar_vue__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__vue_bimonthly_calendar_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__vue_bimonthly_calendar_vue__);
...
function install(Vue) {
  ...
  Vue.component('vue-bimonthly-calendar', __WEBPACK_IMPORTED_MODULE_0__vue_bimonthly_calendar_vue___default.a);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('div', {
    ...
    staticClass: "title"
  }, [_vm._v(_vm._s(_vm.lastYearMonth))])]), _vm._v(" "), _c('div', {
    ...
    staticClass: "dates"
  }, _vm._l((_vm.lastDayList), function(date) {
    return _c('div', {
      staticClass: "item",
      class: ( _obj = {
        event: true
    ...
    }, [_vm._v("\n            " + _vm._s(date.status ? ((_vm.today == date.date) ? '今天' : ((_vm.startDay == date.date) ? '首次' : date.date.split('/')[2])) : ' '))]), _vm._v(" "), (date.status ? (date.title != undefined) : false) ? _c('span', {
